module.exports = {
  up: (queryInterface, Sequelize) =>
    Promise.all([
      ...
      queryInterface.addColumn('Customers', 'area', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'valCurrentInv', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'val30daysInv', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'val60daysInv', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'val90daysInv', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'val120daysInv', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'termsCode', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'customerClass', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'contact', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'phoneNumber', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'shipToAddr1', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'shipToAddr2', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'shipToAddr3', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'shipToAddr4', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
      queryInterface.addColumn('Customers', 'shipToAddr5', {
        type: Sequelize.STRING,
        allowNull: true,
      }),
    ]),
